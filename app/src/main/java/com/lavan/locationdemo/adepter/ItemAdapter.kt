package com.lavan.locationdemo.adepter
...
class ItemAdapter (val context: Context, val items: ArrayList<LocationModel>,
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view),
        ...
        override fun onClick(v: View?) {
            ...
            val loc = items.get(position)
            listener.onItemClick(position,loc)
        }
    }

    interface OnItemClickListener{
        fun onItemClick(position: Int, loc: LocationModel)
    }
}